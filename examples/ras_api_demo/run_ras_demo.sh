...
tmux send-keys -t $SESSION_NAME:0.2 "python3 examples/ras_api_demo/reset_server.py --all && python3 examples/ras_api_demo/init_ras_api.py && python3 examples/ras_api_demo/ras_api_plugin_demo.py" C-m
