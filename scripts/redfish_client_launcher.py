...
def main_menu():
    ...
    while True:
        ...
        if choice == '0':
            ...
            run_script("redfish_client/tests/basic_test.py", "Basic Client Library Test")
            
        elif choice == '2':
            run_script("redfish_client/examples/basic_examples.py", "Comprehensive Client Examples")
            
        elif choice == '3':
            run_script("redfish_client/monitoring.py", "Real-time Monitoring Client Demo")
            
        elif choice == '4':
            run_script("redfish_client/tests/test_suite.py", "Complete Test Suite")
            
        elif choice == '5':
            print("\n🌐 Starting Web Dashboard...")
            print("   Dashboard will be available at: http://localhost:5000")
            print("   Press Ctrl+C to stop the dashboard")
            run_script("redfish_client/tools/web_dashboard.py", "Web-based Monitoring Dashboard")
